...
type GetCertHistoryRequest struct {
	LogId                int64    `protobuf:"varint,1,opt,name=log_id,json=logId,proto3" json:"log_id,omitempty"`
	CrlSetKey            string   `protobuf:"bytes,2,opt,name=crl_set_key,json=crlSetKey,proto3" json:"crl_set_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *GetCertHistoryRequest) Reset()         { *m = GetCertHistoryRequest{} }
func (m *GetCertHistoryRequest) String() string { return proto.CompactTextString(m) }
func (*GetCertHistoryRequest) ProtoMessage()    {}
func (*GetCertHistoryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ad20a6a54aa5af3, []int{17}
}

func (m *GetCertHistoryRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetCertHistoryRequest.Unmarshal(m, b)
}
func (m *GetCertHistoryRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetCertHistoryRequest.Marshal(b, m, deterministic)
}
func (m *GetCertHistoryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetCertHistoryRequest.Merge(m, src)
}
func (m *GetCertHistoryRequest) XXX_Size() int {
	return xxx_messageInfo_GetCertHistoryRequest.Size(m)
}
func (m *GetCertHistoryRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetCertHistoryRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetCertHistoryRequest proto.InternalMessageInfo

func (m *GetCertHistoryRequest) GetLogId() int64 {
	if m != nil {
		return m.LogId
	}
	return 0
...
func (m *GetCertHistoryRequest) GetCrlSetKey() string {
	if m != nil {
		return m.CrlSetKey
	}
	return ""
...
type GetCertHistoryResponse struct {
	Leaves               []*LogLeaf    `protobuf:"bytes,1,rep,name=leaves,proto3" json:"leaves,omitempty"`
	CheckPoints          []*CheckPoint `protobuf:"bytes,2,rep,name=check_points,json=checkPoints,proto3" json:"check_points,omitempty"`
	CurrentIndex         int64         `protobuf:"varint,3,opt,name=current_index,json=currentIndex,proto3" json:"current_index,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}

func (m *GetCertHistoryResponse) Reset()         { *m = GetCertHistoryResponse{} }
func (m *GetCertHistoryResponse) String() string { return proto.CompactTextString(m) }
func (*GetCertHistoryResponse) ProtoMessage()    {}
func (*GetCertHistoryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_5ad20a6a54aa5af3, []int{18}
}

func (m *GetCertHistoryResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetCertHistoryResponse.Unmarshal(m, b)
}
func (m *GetCertHistoryResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetCertHistoryResponse.Marshal(b, m, deterministic)
}
func (m *GetCertHistoryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetCertHistoryResponse.Merge(m, src)
}
func (m *GetCertHistoryResponse) XXX_Size() int {
	return xxx_messageInfo_GetCertHistoryResponse.Size(m)
}
func (m *GetCertHistoryResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetCertHistoryResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetCertHistoryResponse proto.InternalMessageInfo

func (m *GetCertHistoryResponse) GetLeaves() []*LogLeaf {
	if m != nil {
		return m.Leaves
	}
	return nil
...
func (m *GetCertHistoryResponse) GetCheckPoints() []*CheckPoint {
	if m != nil {
...
func (m *GetCertHistoryResponse) GetCurrentIndex() int64 {
	if m != nil {
...
type LogLeaf struct {
	...
	// CrlSetKey- to lookup entries by certificate.
	CrlSetKey            string   `protobuf:"bytes,8,opt,name=crl_set_key,json=crlSetKey,proto3" json:"crl_set_key,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LogLeaf) GetCrlSetKey() string {
	if m != nil {
		return m.CrlSetKey
	}
	return ""
...
type CheckPoint struct {
	CheckPointer         string   `protobuf:"bytes,1,opt,name=check_pointer,json=checkPointer,proto3" json:"check_pointer,omitempty"`
	LatestIndex          int64    `protobuf:"varint,2,opt,name=latest_index,json=latestIndex,proto3" json:"latest_index,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *CheckPoint) GetCheckPointer() string {
	if m != nil {
...
func (m *CheckPoint) GetLatestIndex() int64 {
	if m != nil {
...
func init() {
	...
	proto.RegisterType((*GetCertHistoryRequest)(nil), "trillian.GetCertHistoryRequest")
	proto.RegisterType((*GetCertHistoryResponse)(nil), "trillian.GetCertHistoryResponse")
	...
	proto.RegisterType((*CheckPoint)(nil), "trillian.CheckPoint")
}
...
var fileDescriptor_5ad20a6a54aa5af3 = []byte{
	...
	,
}
...
type TrillianLogClient interface {
	...
	// Get certificate history for a given certificate as defined by crl_set_key and for
	// the given log as defined by the log_id.
	GetCertHistory(ctx context.Context, in *GetCertHistoryRequest, opts ...grpc.CallOption) (*GetCertHistoryResponse, error)
...
func (c *trillianLogClient) GetCertHistory(ctx context.Context, in *GetCertHistoryRequest, opts ...grpc.CallOption) (*GetCertHistoryResponse, error) {
	out := new(GetCertHistoryResponse)
	err := c.cc.Invoke(ctx, "/trillian.TrillianLog/GetCertHistory", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TrillianLogServer interface {
	...
	// Get certificate history for a given certificate as defined by crl_set_key and for
	// the given log as defined by the log_id.
	GetCertHistory(context.Context, *GetCertHistoryRequest) (*GetCertHistoryResponse, error)
...
func _TrillianLog_GetCertHistory_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCertHistoryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TrillianLogServer).GetCertHistory(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/trillian.TrillianLog/GetCertHistory",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TrillianLogServer).GetCertHistory(ctx, req.(*GetCertHistoryRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _TrillianLog_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCertHistory",
			Handler:    _TrillianLog_GetCertHistory_Handler,
		},
		{
			MethodName: "InitLog",
